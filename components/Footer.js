      ...
      <div className="footer__content">
        <ul className="footer__social">
          <li className="footer__social-item">
            <a className="footer__social-link" href="https://twitter.com/laurenashpole" data-ga-click={true} data-ga-category="footer" data-ga-text="Twitter" aria-label="Twitter">
